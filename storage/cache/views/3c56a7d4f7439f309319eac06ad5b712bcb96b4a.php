...
<head>
    ...
    <title><?php echo e($title ?? 'RENOPHP'); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <h1><?php echo e($title ?? 'Welcome to RENOPHP'); ?></h1>
        <p><?php echo e($message ?? 'Your modern PHP framework is ready to use!'); ?></p>
        ...
        <div class="version">
            RENOPHP v1.0.0 | PHP <?php echo e(PHP_VERSION); ?>
        </div>
    </div>
</body>
</html>
