...
class Arr
{
    ...
    /**
     * Determine if any of the given keys exist in an array using "dot" notation.
     */
    ...
    /**
     * Join array elements with a string. The final two elements can use a different glue string.
     */
